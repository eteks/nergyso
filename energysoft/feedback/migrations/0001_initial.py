    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feedback_employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='feedback_employee', to='employee.Employee', verbose_name='Employee')),
            ],
            options={
