...
from .views import EmployeeSet,EventsSet,NewsSet,FeedbackSet,ShoutoutPostSet,PasswordChangeView,NotificationSet,BannerSet,ShoutoutListSet,GalleryListSet,LiveTelecastSet,PollsSet,PollsResultPostSet
...
urlpatterns = [
    ...
    url(r'^polls_employee_result_exists/', PollsResultPostSet.as_view({"get": "list"}), name="employee_result_exists"),
