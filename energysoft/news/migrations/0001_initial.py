    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('news_image', models.ImageField(upload_to=b'', verbose_name='Images')),
                ('news_video', models.FileField(blank=True, upload_to=b'', verbose_name='Video')),
                ('news_document', models.FileField(blank=True, upload_to=b'', verbose_name='Document')),
            ],
            options={
                'ordering': ['id'],
                'verbose_name': 'New',
