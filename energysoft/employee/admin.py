...
class EmployeeAdmin(admin.ModelAdmin):
	...
	model = Employee
	form= EmpFileForm
	exclude = ('password','first_name','last_name','is_superuser','is_active','last_login','date_joined','groups','user_permissions','email','is_staff','active_status','delete_status',)
