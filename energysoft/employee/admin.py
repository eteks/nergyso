...
class EmployeeAdmin(admin.ModelAdmin):
	...
	fields = ('username','first_name','last_name','email','employee_id','employee_name','employee_dob','employee_mobile','employee_doj','employee_department','employee_designation','employee_photo','gal_image','employee_bloodgroup','employee_address','employee_experience_in_years',)
